...
export default function Home() {
  return (
    <div>
      ...
      <p>Breed Results</p>
      <Link to='/b/babymama'>BabyMama</Link> <br />
      <Link to='/b/babythief'>BabyThief</Link> <br />
      <Link to='/b/failure'>Failure</Link> <br />
      <Link to='/b/guard'>Guard</Link> <br />
      <Link to='/b/leader'>Leader</Link> <br />
      <Link to='/b/member'>Member</Link> <br />
