      ...
      <div className="container">
          ...
          <Col>
            <div className="text-end">
              ...
              <div style={{ position: "relative" }}>
                <input className="topInput" type="text" placeholder="889" />
        ...
        <div>
          ...
          <div className="bottomBtns">
            <button className='mybtn mybtn-p'>ADD</button>
            <button className='outlinebtn'>SELECT</button>
            <button className='outlinebtn'>PURCHASE</button>
            <button className='notbtn'>My Offers</button>
          </div>
        </div>
      </div>
    </div>
