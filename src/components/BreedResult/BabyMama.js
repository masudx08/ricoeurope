...
export default function BabyMama() {
  return (
    <div className='breedResultCont'>
      <div>
        ...
        <h2 className='highlight-text' style={{fontWeight:'900', fontFamily:'Gilroy', letterSpacing:'2px'}}>1X BABYMAMA</h2>
        <div className="mycard">
          <img style={{height:'80%'}} src={BabyMamaImg} alt="" />
